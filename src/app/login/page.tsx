...
export default function LoginPage() {
    ...
    <div className="flex min-h-screen flex-col items-center justify-start bg-gradient-to-b from-[#FAF8F0] via-[#FAF8F0] to-[#E2E8DD] px-4 pt-30 pb-16">
        ...
        <div className="flex justify-between items-center mb-6 text-xs text-[#386641] font-medium">
            <Link href="/" className="flex items-center gap-1 hover:underline">← Kembali</Link>
            <a href="#" className="flex items-center gap-1 hover:underline"> Bantuan</a>
        </div>

        <h2 className="text-xl font-bold text-gray-800">Login</h2>
        <p className="text-xs text-gray-400 mb-6">Temukan karir impianmu disini.</p>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            />
            <span className="text-[10px] text-gray-400 mt-1 block px-1">Contoh: email@karir.com</span>
            </div>
            ...
            <Link href="/register" className="text-xs font-semibold text-[#386641] hover:underline">
                Buat Akun
            </Link>
            </div>
        </form>
        ...
        <div className="space-y-3">
            <button type="button" className="flex w-full items-center justify-center gap-2 rounded-lg border border-[#386641] px-4 py-2.5 text-sm font-semibold text-[#386641] bg-white hover:bg-gray-50 transition">
        ...
        <div className="mt-8 pt-4 border-t border-gray-100 text-center text-xs text-gray-500">
            Apakah Anda HR? <a href="#" className="text-[#386641] font-semibold hover:underline">Buka Lowongan di KerjaBagus.com</a>
        </div>
        </div>
    </div>
    );
