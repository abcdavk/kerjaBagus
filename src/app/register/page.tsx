...
export default function RegisterPage() {
    ...
    <div className="mb-6 text-center flex flex-col items-center justify-center">
        ...
        <h2 className="text-center text-xl font-bold text-gray-800">Buat Akun</h2>
        <p className="text-center text-sm text-gray-500 mb-5">
            Sudah punya akun? <Link href="/login" className="text-blue-500 hover:underline">Sign in</Link>
        </p>

        <div className="flex flex-col sm:flex-row gap-3 mb-6">
            <button type="button" className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-blue-500 px-4 py-2.5 text-sm font-medium text-blue-600 hover:bg-blue-50 transition">
            <span className="font-bold text-red-500">G</span> Daftar dengan Google
            </button>
            <button type="button" className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-blue-500 px-4 py-2.5 text-sm font-medium text-blue-600 hover:bg-blue-50 transition">
            <span className="font-bold text-blue-700">f</span> Daftar dengan Facebook
            </button>
        </div>
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="w-1/2">
                ...
                className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:border-[#386641] focus:outline-none transition"
                />
                <span className="text-[10px] text-gray-400 mt-1 block px-1">Nomor terhubung dengan WhatsApp.</span>
            </div>
            </div>
            ...
            <input
                ...
                className="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm focus:border-[#386641] focus:outline-none transition"
            />
            <span className="absolute right-3 top-3.5 cursor-pointer text-gray-400 text-xs">👁️</span>
            <div className="flex justify-between items-center mt-1 px-1">
                <span className="text-[10px] text-gray-400">Minimal 8 karakter, huruf kapital, dan angka.</span>
                <span className="text-[10px] text-gray-400">Too Short <span className="inline-block w-12 h-1 bg-gray-200 rounded-sm"></span></span>
            </div>
            </div>
            ...
            Dengan mendaftar Anda menyetujui <a href="#" className="text-blue-500 hover:underline">Syarat dan Ketentuan</a> & <a href="#" className="text-blue-500 hover:underline">Kebijakan Privasi</a>.
            </p>
