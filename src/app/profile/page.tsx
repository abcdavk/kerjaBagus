    ...
    <div className="min-h-screen bg-[#FAF8F0] px-6 py-10">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="w-full md:w-auto flex items-center justify-center gap-2 border border-amber-300 bg-amber-50 rounded-xl px-4 py-2.5 text-xs font-semibold text-amber-900 shadow-sm">
            <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse"></span>
            <span>Peran: {(userData as any)?.role === "CLIENT" ? "Pemberi Kerja" : "Pencari Kerja"}</span>
          </div>
          {/* <button
